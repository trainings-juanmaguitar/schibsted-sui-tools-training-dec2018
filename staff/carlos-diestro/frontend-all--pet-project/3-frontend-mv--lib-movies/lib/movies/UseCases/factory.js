...
var _DiscoverMoviesUseCase = require('./DiscoverMoviesUseCase');

var _DiscoverMoviesUseCase2 = _interopRequireDefault(_DiscoverMoviesUseCase);
...
}, _class.discoverMoviesUseCase = function (_ref) {
  var config = _ref.config;
  return new _DiscoverMoviesUseCase2.default({
    config: config,
