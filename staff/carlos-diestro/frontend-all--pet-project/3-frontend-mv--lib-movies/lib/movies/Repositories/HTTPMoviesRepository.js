  ...
  (0, _createClass3.default)(HTTPMoviesRepository, [{
    ...
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
        var apiKey, url, _ref3, results, movies;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                url = this._config.get('URL_BASE') + 'discover/movie?api_key=' + apiKey + '&language=en-US&sort_by=popularity.desc';
                _context.next = 4;
              ...
              case 4:
                ...
                return _context.abrupt('return', movies.map(this._moviesEntityFactory));
