...
const useCases = {
  ...
  get_movie_details_by_id_use_case: MoviesUseCasesFactory.getMovieDetailsByIdUseCase({config}),
  get_popular_movies_use_case: MoviesUseCasesFactory.getPopularMoviesUseCase({config})
}
